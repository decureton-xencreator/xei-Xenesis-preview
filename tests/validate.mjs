...
for(const asset of ['executive-arrival-v1.js?v=bespoke-1','executive-arrival-v1.css?v=transparent-chg-lockup-2','xps-diamond-publication-lock-v1.css?v=canonical-geometry-2','checkmate-living-lockup-v1.css?v=1','ed-canonical-guard-v1.css?v=1','ed-premiere-clean-v1.js?v=xvs-001-ed-canonical-v4','xfs-xen-centric-finish-v1.js?v=solutions-gateway-2','xfs-xen-centric-finish-v1.css?v=commercial-rollout-1','xen-conversation-mode-v1.js?v=1','xen-conversation-mode-v1.css?v=1','ed-video-pass-v1.css?v=video-review-2'])if(!html.includes(asset))throw new Error(`Active finish asset missing: ${asset}`);
