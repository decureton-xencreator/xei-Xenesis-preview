...
document.addEventListener('click',event=>{const button=event.target.closest('[data-select-path]');if(button)renderBrief(button.dataset.selectPath)});
