...
if(isPhone){
  ...
  body.classList.remove('phone-premiere-started');
  const begin=()=>{
    const btn=document.querySelector('#phoneGoldBegin');
  ...
  shell.querySelector('#phoneGoldBegin').addEventListener('click',begin,{once:true});
}
