Warning: truncated output (original token count: 137975)
Total output lines: 14726

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=continuum/wrangler.jsonc --env=staging continuum/worker-configuration.d.ts` (hash: fa5d530e7bb136ea36ffec606c6aeed9)
...
interface __BaseEnv_Env {
	...
	ANTHROPIC_MAX_CONCURRENCY?: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XEN_RUNTIME_MODE" | "XEN_AUTH_MODE" | "XEN_MODEL_EXECUTION" | "ANTHROPIC_MODEL" | "ANTHROPIC_MAX_CONCURRENCY" | "ANTHROPIC_DAILY_BUDGET_USD" | "ANTHROPIC_MISSION_BUDGET_USD">> {}
}
...
interface StreamPipeOptions {
     ...
     *
     * If …87975 tokens truncated…st query).
 | 'first-unconstrained';
