...
I would allocate approximately three thousand five hundred dollars to intensive model, coding, testing, and research usage; two thousand dollars to persistent memory, authentication, hosting, observability, and security; fifteen hundred dollars to one continuous canonical voice and media system; two thousand dollars to finish one inspectable Living Company pilot and its executive command environment; and one thousand dollars as a controlled reserve for defects, deployment friction, and the unknowns a real build always reveals.
